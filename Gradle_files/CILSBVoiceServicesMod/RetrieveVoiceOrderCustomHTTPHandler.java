...
public class RetrieveVoiceOrderCustomHTTPHandler implements DataHandler{
...
//			  convertedStr = convertDataObjectToString(maxFlowObject);
			  ...
			  convertedStr = RemoveNameSpaceUtil.removeNameSpaceString(maxFlowObject,"orderDetailsRequest", "OrderDetailsRequest.xsd", true);
			  System.out.println("ConvertedStr - " + convertedStr);

			  convertedStr = convertedStr.replace("<orderDetailsRequest>","<orderDetailsRequest  xsi:noNamespaceSchemaLocation='OrderDetailsRequest.xsd' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>");

			}
			System.out.println("Final request sent to orderDetailsRequest:"+convertedStr);
